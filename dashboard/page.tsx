...
const TURA_BADGE: Record<string, { bg: string; color: string }> = {
...
export default function Dashboard() {
  ...
  const turaAzi = getTura(azi, angajat, echipa)
    ...
    <div style={{ minHeight: '100vh', background: '#1a1a1f', paddingBottom: 80, paddingTop: 'env(safe-area-inset-top,0px)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px 8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{
            ...
            boxShadow: '0 2px 8px rgba(42,109,217,0.4)',
          }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          {/* Clopoțel */}
          <button onClick={() => router.push('/notificari')} style={{
      ...
      <div style={{ padding: '8px 16px 0' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: cardStyle.labelColor, fontWeight: 500, marginBottom: 4, textTransform: 'capitalize' }}>
            {dataLabel}
          </div>
          <div style={{ fontSize: 34, fontWeight: 800, color: 'white', letterSpacing: -0.5, lineHeight: 1.1, marginBottom: 6 }}>
            {infoAzi.label}
          </div>
          {ORA_TURA[turaAzi] && (
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <button onClick={() => setWeekOffset(o => o-1)} style={{
                width: 26, height: 26, borderRadius: 7, background: '#26262e',
                border: '1px solid rgba(255,255,255,0.08)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
              }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 6 }}>
            {days.map((d, i) => {
              ...
              const badge = TURA_BADGE[tip] ?? TURA_BADGE.L
              ...
              return (
                <div key={i} style={{
                  ...
                  <span style={{ fontSize: 10, fontWeight: 600, color: isToday ? '#60a5fa' : '#6b6b80' }}>
                    {ZILE[i]}
                  </span>
                  <div style={{
                    width: '100%', aspectRatio: '1', borderRadius: 10,
                    background: badge.bg,
                    border: isToday ? '1.5px solid #60a5fa' : '1px solid rgba(255,255,255,0.06)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
